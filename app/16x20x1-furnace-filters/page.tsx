...
export default function Size16x20Page() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <AmazonShopExamples face="16x20x1" />
      ...
      <div className="prose-fit mt-10">
        ...
        <p>
          16×20 is not 16×25, not <Link href="/14x20x1-furnace-filters">14×20</Link>, and not{" "}
          <Link href="/20x20x1-furnace-filters">20×20</Link>. A filter that “almost” fits either leaks or
        ...
        <p>
          ...
          <Link href="/16x20x4-furnace-filters">16×20×4 comparison</Link>. See also{" "}
      ...
      <div className="prose-fit mt-10">
        ...
        <p>
          ...
          stuffing 1-inch pads in the deep slot — use the depth you already paid for, and start
          with the <Link href="/16x20x4-furnace-filters">16×20×4 comparison</Link>.
        </p>
