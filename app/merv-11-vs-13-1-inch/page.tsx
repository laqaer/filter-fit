    ...
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="prose-fit mt-10">
        ...
        <p>
          ...
          argument applies to <Link href="/20x25x1-furnace-filters">20×25×1</Link>,{" "}
          <Link href="/16x20x1-furnace-filters">16×20×1</Link>, and the less-common{" "}
          <Link href="/12x24x1-furnace-filters">12×24×1</Link>,{" "}
          <Link href="/24x24x1-furnace-filters">24×24×1</Link>, and{" "}
          <Link href="/24x30x1-furnace-filters">24×30×1</Link>. If you can change the
          cabinet, read{" "}
