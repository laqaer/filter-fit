  ...
  return (
    <section className="mt-10 border border-rule bg-card p-5">
      ...
      <p className="mt-2 text-sm leading-6 text-ink-soft">
        Affiliate links — we may earn a commission if you buy, at no extra cost to you. These are
        Amazon searches for {faceLabel} at MERV 8, 11, and 13, not a ranked list and not products
        we tested.
      </p>
